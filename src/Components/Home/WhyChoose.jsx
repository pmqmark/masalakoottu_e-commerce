...
const WhyChoose = () => {
  return (
    <section className="w-full min-h-[650px] bg-[#365420] text-white px-6 md:px-5 lg:px-24 lg:gap-0 md:gap-4 flex flex-col md:flex-row items-center justify-between py-6 lg:py-10">
      
      {/* Left Content - On Top for Mobile */}
      <div className="w-full md:w-1/2 text-center md:text-left mb-10 md:mb-0">
        <h3 className="text-orange-400 text-lg italic mb-2">Why Choose Ogenix</h3>
        <h2 className="w-full lg:w-[480px] font-extrabold text-[34px] lg:text-[44px] leading-[40px] md:leading-tight tracking-tight">
          Few reasons for people choosing Ogenix
        </h2>
        <p className="w-full lg:w-[506px] text-gray-300 mt-4 leading-relaxed mx-auto md:mx-0">
      ...
      <div className="w-full md:w-[55%] lg:w-[65%] xl:w-[70%] bg-white p-6 lg:p-8 rounded-lg shadow-lg text-gray-900 grid grid-cols-2 gap-6 min-h-[400px]">
